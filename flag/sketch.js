...
function draw() {
  ...
  fill('white');
  circle(145,168,31);
  triangle(131,168,123,160,132,162);
  ...
  triangle(150,235,160,221,162,241);
  triangle(158,241,176,233,171,251);
  triangle(173,250,188,252,174,261);
  triangle(175,262,188,272,168,271);
  triangle(168,272,179,291,162,281);
  triangle(162,282,158,299,148,280);
  triangle(150,284,140,298,136,271);
  triangle(140,276,122,290,127,270);
  triangle(127,270,109,268,126,258);
  triangle(126,258,111,248,128,249);
  triangle(128,249,122,231,137,240);
